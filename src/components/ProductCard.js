...
class ProductCard extends React.Component {
    ...
    render() {
        const { id, image, name, price, description, location, size, index } = this.props;
        return (
            <React.Fragment>
                <div className="col-lg-3 col-sm-4 my-1">
                    <a href=""><div className="card p-1 text-center text-dark productCard" style={{ width: "15rem", height: "25rem" }}>
                        ...
                        <div className="card-body">
                            ...
                            {/* <a href="#" className="btn btn-danger details">Details</a> */}
                        </div>
                    </div>
                    </a>
                </div>
